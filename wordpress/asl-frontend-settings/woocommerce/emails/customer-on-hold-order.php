<?php
/**
 * Customer on-hold order email - Aromatic Scents Lab Custom Style
 *
...
<p class="email-text" style="font-size: 14px; line-height: 1.7; color: #c0392b; margin: 0 0 15px 0;">
	...
	printf(
		...
		esc_html__( 'Thanks for your order at %s. Your order is on-hold until we confirm payment has been received.', 'woocommerce' ),
