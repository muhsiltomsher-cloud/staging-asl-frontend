<?php
/**
 * POS Completed Order email - Aromatic Scents Lab Custom Style
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/pos-completed-order.php.
 *
...
<p class="email-text" style="font-size: 14px; line-height: 1.7; color: #c0392b; margin: 0 0 15px 0;">
	...
	printf(
		...
		esc_html__( 'Thank you for your in-store purchase at %s. Your order is now complete.', 'woocommerce' ),
