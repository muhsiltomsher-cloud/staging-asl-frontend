<?php
/**
 * Customer failed order email - Aromatic Scents Lab Custom Style
 *
...
<p class="email-text" style="font-size: 14px; line-height: 1.7; color: #c0392b; margin: 0 0 15px 0;">
	...
	printf(
		...
		esc_html__( 'Unfortunately your order #%1$s at %2$s could not be processed. Please try again or contact us for assistance.', 'woocommerce' ),
...
<p style="margin: 20px 0;">
	<a href="<?php echo esc_url( $checkout_url ); ?>" class="button" style="display: inline-block; padding: 14px 28px; background-color: #1a1a1a; color: #ffffff !important; text-decoration: none; font-size: 13px; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;"><?php esc_html_e( 'Try again', 'woocommerce' ); ?></a>
</p>
