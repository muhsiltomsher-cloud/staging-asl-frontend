<?php
/**
 * Customer note email - Aromatic Scents Lab Custom Style
 *
...
<p class="email-text" style="font-size: 14px; line-height: 1.7; color: #c0392b; margin: 0 0 15px 0;">
	<?php esc_html_e( 'The following note has been added to your order:', 'woocommerce' ); ?>
</p>

<blockquote style="margin: 20px 0; padding: 15px 20px; background-color: #f8f8f8; border-left: 4px solid #c0392b; font-style: italic; color: #1a1a1a;">
