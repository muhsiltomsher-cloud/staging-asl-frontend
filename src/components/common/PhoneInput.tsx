            ...
            <div className="border-b p-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-md border border-gray-200 py-2 pl-9 pr-3 text-base sm:text-sm focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900"
                  dir="ltr"
                />
              </div>
            </div>
