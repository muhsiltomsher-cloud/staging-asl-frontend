...
export function MobileBottomBar({ locale, settings, dictionary }: MobileBottomBarProps) {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 rounded-t-2xl border-t bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.08)] md:hidden">
            ...
            if (isDrawerItem) {
              return (
                <button
                  ...
                  className="relative flex flex-1 flex-col items-center justify-center gap-1 py-2 text-gray-600 transition-colors hover:text-gray-900 active:scale-95"
                >
